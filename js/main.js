var vid = "";
var page = angular.module('pageContentApp', ['ngRoute', 'ngAnimate', 'youtube-embed', 'ngSanitize']);
...
//                     TweenMax.To($('.loading'), .7, {opacity: 1, ease: Power2.easeIn});
//                 });
//
//                 $rootScope.$on('$routeChangeSuccess', function()
//                 {
//                     scope.isRouteLoading = false;
//                     TweenMax.to($('.loading'), .7, {opacity: 0, ease: Power2.easeIn});
//                 });
//             }
//         };
//     };
